package com.example.projekat_rmas.service
...
class LocationService : Service() {
    ...
    private val notificationInterval = 60 * 20 * 1000 //20 minuta
                    ...
                    if (lat != null && lon != null) {
                        ...
                        if (distance < 100) {
                            ...
                            if (currentTime - lastNotificationTime > notificationInterval) {
                                sendNotification("Object Nearby", "You're near $title - $type.\nSubject: $subject. Check it out!")
